...
class App extends React.Component {
    ...
    render() {
        return (
            <div>
                <h2>DataGrid Styling</h2>
                <DataGrid data={this.state.data} rowCss={this.getRowCss} style={{ height: 250 }}>
                    <GridColumn field="itemid" title="Item ID"></GridColumn>
                    <GridColumn field="name" title="Name"></GridColumn>
                    <GridColumn field="listprice" title="List Price" align="right" cellCss={this.getCellCss}></GridColumn>
