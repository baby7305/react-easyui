...
class App extends React.Component {
    ...
    getFooterData() {
        return [
            { name: "Average:", unitcost: 19.8, listprice: 60.4 },
            { name: "Total:", unitcost: 198.0, listprice: 604.0 }
        ]
    }
    render() {
        return (
            <div>
                <h2>Footer Rows</h2>
                <DataGrid showFooter data={this.state.data} footerData={this.state.footerData} style={{ height: 250 }}>
